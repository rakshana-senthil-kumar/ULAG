...
taskkill /FI "WINDOWTITLE eq ULAG Backend*" /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq ULAG Frontend*" /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq BHUMI-FUSION Backend*" /F >nul 2>&1
taskkill /FI "WINDOWTITLE eq BHUMI-FUSION Frontend*" /F >nul 2>&1

echo.
echo ================================================================
echo   All ULAG services have been stopped.
